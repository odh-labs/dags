...
args = {
    "project_id": "user27-brbaker2-0925035825",
}

dag = DAG(
    "user27-brbaker2-0925035825",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using user27-brbaker2.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="user27-brbaker2-0925035825",
