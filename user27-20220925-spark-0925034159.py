...
args = {
    "project_id": "user27-20220925-spark-0925034159",
}

dag = DAG(
    "user27-20220925-spark-0925034159",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using user27-20220925-spark.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="user27-20220925-spark-0925034159",
    ...
    env_vars={
        ...
        "SPARK_CLUSTER": "user27-cluster",
        "WORKER_NODES": "2",
        "S3_ENDPOINT_URL": "http://minio-ml-workshop:9000:9000",
    },
    config_file="None",
    dag=dag,
)
