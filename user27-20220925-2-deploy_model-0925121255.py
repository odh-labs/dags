...
args = {
    "project_id": "user27-20220925-2-deploy_model-0925121255",
}

dag = DAG(
    "user27-20220925-2-deploy_model-0925121255",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using user27-20220925-2-deploy_model.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="user27-20220925-2-deploy_model-0925121255",
